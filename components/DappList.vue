  ...
  data() {
    return {
      ...
      fields: [
        ...
        {
          help:
            'Rank is based on multiple factors including active users (unique source addresses in transactions to ÐApp contracts), transaction volume, CTRs, and user recommendations',
          id: 'rank',
          order: 'asc',
          title: 'Rank'
        },
